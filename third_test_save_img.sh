work_dir="/media/data3/yebh/code/mmdetection/work_dirs/test_dataset/T2L_SCL/cate-1k1k/yolo-da-T2L-newanchor-da-mse-1k-1k-0-v00625-sclv2-64-444-441"
config_name="uda_yolov3_T2L_SCL-1k1k0-00625.py"
epoch=232
# work_dir="/media/data3/yebh/code/mmdetection/work_dirs/test_dataset/L2T_SCL/cate-1h1h/yolo-da-L2T-newanchor-da-mse-1h-1h-0-v00875-sclv2-64-cn4-v5-254-250"
# config_name="uda_yolov3_L2T_SCL-1h1h0-00875.py"
# epoch=113
  
config_dir=${work_dir}/${config_name}
model_dir=${work_dir}/epoch_${epoch}.pth
log_dir=${work_dir}/${epoch}_show_img.log
show_dir=${work_dir}/image_${epoch}_2
gpu_ids=0
