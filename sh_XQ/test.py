...
for test_dataset in args.target_dataset:
    ...
    # print(log_dir)
    # print(out_dir)
    # print(f"data.test.img_prefix={root_dir}/dataset/{dataset_tag}/{test_dataset}/JPEGImages")
    # print(f"data.test.ann_file={root_dir}/dataset/{dataset_tag}/{test_dataset}/{test_dataset}_test.json")
    # input("ed")
    import subprocess
    subprocess.call([
        "python",
