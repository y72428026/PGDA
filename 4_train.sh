...
configs=work_dirs/test_dataset/T2L_SCL/CFA_608/uda-yolov3-T2L-SCL-75k75k0-cfav9-0.0625-cT0.3-pT0.0-a0.7-gpu4-v2/uda-yolov3-T2L-SCL-75k75k0-cfav9-0.0625-cT0.3-pT0.0-a0.7.py
work_dir=work_dirs/test_dataset/T2L_SCL/CFA_608/uda-yolov3-T2L-SCL-75k75k0-cfav9-0.0625-cT0.3-pT0.0-a0.7-gpu4-v2
python tools/train.py $configs --gpu-id=${gpu} --work-dir=${work_dir} --auto-scale-lr --seed=1079546523 
python read_json_and_save_top50.py --path=${work_dir} 
# ### L2T
# dataset=L2T
